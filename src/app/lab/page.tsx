    ...
    <div className="min-h-full bg-zinc-950 text-zinc-100">
      <main className="mx-auto w-full max-w-6xl space-y-8 px-4 py-10 md:px-6">
        <div className="max-w-3xl space-y-3">
          <p className="text-xs text-amber-200">ریپوی پرچم · سیستم کامل با ارزیابی</p>
          ...
          <p className="text-sm leading-8 text-zinc-400 md:text-base">
            پیکرهٔ مهندسی RAG، قطعه‌بندی پایدار، BM25 و TF-IDF و هیبرید RRF، پاسخ extractive با استناد، و امتناع وقتی مدرک نیست.
            این یک رپر API چت نیست. جدول مقایسه را در{" "}
